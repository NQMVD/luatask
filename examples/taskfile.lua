...
tasks.deps = {
  ...
  run = function()
    ...
    return Result.SUCCESS, "gcc-11.2", "make-4.3"
  end
}
...
tasks.build = {
  ...
  run = function(target, mode)
    ...
    return Result.SUCCESS, os.time(), artifact_count
  end
}
...
tasks.test_unit = {
  ...
  run = function(...)
    ...
    return Result.SUCCESS, 42 -- number of tests
  end
}
...
tasks.test_integration = {
  ...
  run = function()
    ...
    return Result.SUCCESS, 8 -- number of integration tests
  end
}
...
tasks.package = {
  ...
  run = function(format)
    ...
    return Result.SUCCESS, package_name, 1024000 -- package size in bytes
  end
}
...
tasks.deploy_staging = {
  ...
  run = function()
    ...
    return Result.SUCCESS, deploy_id
  end
}
...
tasks.version = {
  ...
  run = function()
    ...
    return Result.SUCCESS, "1.0.0", "2024-01-15"
  end
}
...
tasks.benchmark = {
  ...
  run = function(iterations)
    ...
    return Result.SUCCESS, avg_time, iterations
  end
}
...
tasks.lint = {
  ...
  run = function()
    ...
    return Result.SUCCESS, 3 -- warning count
  end
}
...
tasks.flaky = {
  ...
  run = function()
    ...
    log.info("Flaky task succeeded this time")
    return Result.SUCCESS
  end
}
...
tasks.configure = {
  ...
  run = function(env, debug, workers)
    ...
    return Result.SUCCESS, env, debug, workers
  end
}
